    ...
    return (
        <div className="flex min-h-screen bg-[#0f172a] text-slate-100 font-sans">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden order-last">
                <div className="absolute inset-0 bg-gradient-to-bl from-purple-600/20 to-indigo-800/20"></div>
                ...
                <div className="relative z-10 flex flex-col justify-center px-12 text-white">
                    ...
                    >
                        <h1 className="text-5xl font-bold mb-6 tracking-tight">Join the <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-indigo-400">Future of Work</span></h1>
                        <p className="text-xl text-slate-300 max-w-md leading-relaxed">
                            Empower your team with tools that drive productivity and engagement.
                        </p>
                    </motion.div>
                </div>
            </div>
            ...
            <div className="flex items-center justify-center w-full lg:w-1/2 p-8 relative">
                ...
                <div className="absolute top-0 left-0 w-[300px] h-[300px] bg-purple-500/10 rounded-full blur-[80px] pointer-events-none"></div>
                <div className="absolute bottom-0 right-0 w-[300px] h-[300px] bg-indigo-500/10 rounded-full blur-[80px] pointer-events-none"></div>
                ...
                <GlassCard className="w-full max-w-md p-10 !bg-slate-800/50 !border-slate-700/50 shadow-2xl backdrop-blur-xl">
                    <div className="mb-8 text-center lg:text-left">
                        ...
                        <p className="mt-2 text-slate-400">Start your journey with Employee360</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="block w-full pl-10 pr-3 py-3 bg-slate-900/50 border border-slate-700 rounded-xl text-white placeholder-slate-500 focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500/50 transition-all"
                                    placeholder="johndoe"
                                    required
                                />
                            </div>
                        ...
                        <Button type="submit" className="w-full flex items-center justify-center group !bg-gradient-to-r !from-purple-600 !to-indigo-600 hover:!from-purple-500 hover:!to-indigo-500">
                            Register
